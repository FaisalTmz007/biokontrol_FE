...
export default function Dashboard() {
  ...
  const fetchSystemStatus = useCallback(async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/system-status`
      );
  ...
  const checkWarmupStatus = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/warmup-status`
      );
      const result = await response.json();
  ...
  const fetchChartData = useCallback(async () => {
    ...
    // Cek cache (valid untuk 2 menit)
    if (dataCache[cacheKey] && now - dataCache[cacheKey].timestamp < 120000) {
      setHistoricalData(dataCache[cacheKey].historical);
      setSensorErrors(dataCache[cacheKey].errors);
      return;
    }
  ...
  const handlePhCalibration = async () => {
    ...
    try {
      // FIXED: URL construction
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/calibrate-ph`,
        {
          method: "POST",
          headers: {
      ...
      alert(
        "Terjadi kesalahan saat kalibrasi pH. Pastikan koneksi internet stabil."
      );
    } finally {
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-yellow-700 text-sm">
                  Data sensor sedang distabilkan. Penyimpanan data akan aktif
                  setelah warmup selesai.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <div className="flex flex-col items-center">
              <div className="text-4xl font-bold text-indigo-600">
                {sensorData.pressure.toFixed(2)} kPa
              </div>
              <div className="text-sm text-gray-500 mt-2">
                Normal: 100 - 110 kPa
              </div>
            ...
            <div className="h-80">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={sensorErrors}>
                  ...
                  <Line
                    type="monotone"
                    dataKey="temp_delta_error"
                    stroke="#EF4444"
                    name="Temp Delta Error"
                    strokeWidth={2}
                  />
                </LineChart>
              </ResponsiveContainer>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPhCalibration((prev) => ({
                    ...prev,
                    referencePh: e.target.value,
                  }))
                }
              ...
              <p className="text-xs text-gray-500 mt-1">
                Nilai pH dari alat ukur standar
              </p>
            </div>
            ...
            <div>
              <button
                ...
                disabled={
                  ...
                  !phCalibration.referencePh ||
                  !phCalibration.currentPh
                }
              ...
              {phCalibration.referencePh && phCalibration.currentPh && (
                <div className="mt-2 p-2 bg-gray-50 rounded text-sm">
                  ...
                  <div className="font-mono text-blue-600">
                    {(
                      parseFloat(phCalibration.referencePh) -
                      parseFloat(phCalibration.currentPh)
                    ).toFixed(3)}
                  </div>
                </div>
              )}
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            ...
            <ol className="text-sm text-blue-800 space-y-1">
              ...
              <li>
                2. Masukkan nilai pH meter ke kolom &quot;Nilai pH Meter&quot;
              </li>
              <li>
                3. Masukkan nilai pH yang terbaca sensor ke kolom &quot;Nilai pH
                Sensor&quot;
              </li>
              <li>
                4. Klik tombol &quot;Kalibrasi pH&quot; untuk mengirim offset ke
                ESP32
              </li>
              <li>
                2. Masukkan nilai pH meter ke kolom &quot;Nilai pH Meter&quot;
